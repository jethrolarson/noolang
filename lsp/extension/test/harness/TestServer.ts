/**
 * Test-specific LSP server that can be initialized with custom transport.
 * This mirrors server.ts but allows passing a custom connection for testing.
 */
...
export function createTestServer(connection: Connection): void {
