...
The suite proves inference doesn't _crash_, not that the inferred type is _right_ —
...
- Record patterns in `match` and destructuring bindings (`{@a} = r`) bind a _subset_ of
